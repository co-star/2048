...
function config(){
	...
	//得到cell的宽高
	var cellWidth = (4/21)*width;
	var cellHeight = (4/21)*height;
	var base_marginLeft = cellWidth*1/4;
	var base_marginTop = cellHeight*1/4;
	console.log("cell width height is "+
		cellWidth+" "+cellHeight);
	console.log("base-margin left top is "+
		base_marginLeft+" "+base_marginTop)
	...
	var list_cell = ['#c00','#c01','#c02','#c03'];
	var list_grid = ['#g00','#g01','#g02','#g03'];
	for(var i=0;i<4;i++)
	{
		$(list_cell[i]).css({
			top:base_marginTop,
			left:base_marginLeft*(i+1)+cellWidth*i
		})
		$(list_grid[i]).css({
			top:base_marginTop,
			left:base_marginLeft*(i+1)+cellWidth*i
	...
	var list_cell = ['#c10','#c11','#c12','#c13'];
	var list_grid = ['#g10','#g11','#g12','#g13'];
	for(var i=0;i<4;i++)
	{
		$(list_cell[i]).css({
			top:base_marginTop*2+cellHeight,
			left:base_marginLeft*(i+1)+cellWidth*i
		})
		$(list_grid[i]).css({
			top:base_marginTop*2+cellHeight,
	...
	var list_cell = ['#c20','#c21','#c22','#c23'];
	var list_grid = ['#g20','#g21','#g22','#g23'];
	for(var i=0;i<4;i++)
	{
		$(list_cell[i]).css({
			top:base_marginTop*3+cellHeight*2,
			left:base_marginLeft*(i+1)+cellWidth*i
		})
		$(list_grid[i]).css({
			top:base_marginTop*3+cellHeight*2,
	...
	var list_cell = ['#c30','#c31','#c32','#c33'];
	var list_grid = ['#g30','#g31','#g32','#g33'];
	for(var i=0;i<4;i++)
	{
		$(list_cell[i]).css({
			top:base_marginTop*4+cellHeight*3,
			left:base_marginLeft*(i+1)+cellWidth*i
		})
		$(list_grid[i]).css({
			top:base_marginTop*4+cellHeight*3,
